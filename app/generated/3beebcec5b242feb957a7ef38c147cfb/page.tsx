...
export default function SaaSDashboardShell() {
  ...
  const [notifItems, setNotifItems] = React.useState([
    ...
    },
    {
      id: 3,
      title: 'Export ready',
      snippet: 'Your CSV export is complete',
      timestamp: '3h',
      read: true
    }
  ]);
  ...
  const orgs = [
    {
      id: 'acme',
      name: 'Acme Inc.',
      logo: 'https://dummyimage.com/24x24/111827/ffffff&text=A'
    },
    {
      id: 'globex',
      name: 'Globex',
      logo: 'https://dummyimage.com/24x24/2563eb/ffffff&text=G'
    },
    {
      id: 'initech',
      name: 'Initech',
      logo: 'https://dummyimage.com/24x24/16a34a/ffffff&text=I'
    }
  ];
  ...
  const kpis = [
    {
      ...
      value: 128540,
      delta: 5.2,
      series: [95, 98, 102, 105, 110, 115, 118, 120, 122, 128],
      note: 'MRR = sum of monthly subscription revenue'
    },
    {
      key: 'ARR',
      ...
      value: 1542480,
      delta: 4.1,
      series: [1200, 1240, 1290, 1330, 1380, 1420, 1470, 1490, 1520, 1542]
    },
    {
      key: 'ACTIVE',
      title: 'Active Users',
      value: 18432,
      delta: 2.7,
      series: [15, 15.2, 15.6, 16, 16.4, 16.9, 17.3, 17.9, 18.2, 18.4]
    },
    {
      key: 'CHURN',
      title: 'Churn Rate',
      value: 3.1,
      delta: -0.4,
      series: [4.2, 4.1, 3.9, 3.8, 3.6, 3.5, 3.3, 3.2, 3.1, 3.1]
    }
  ];
  ...
  const revenueSeries = [
    {
      name: 'MRR',
      data: [
        95, 96, 98, 99, 100, 102, 104, 105, 106, 108, 110, 112, 113, 115, 116,
        118, 119, 120, 121, 123, 124, 125, 126, 127, 128, 129, 130, 131, 132,
        133
      ]
    },
    {
      name: 'Expansion',
      data: [
        5, 5, 6, 7, 7, 8, 8, 9, 9, 10, 10, 11, 11, 12, 12, 13, 13, 14, 14, 15,
  ...
  const filteredTx = txAll.filter((r) =>
    r.customer.name.toLowerCase().includes(txSearch.toLowerCase())
  );
  const pageData = filteredTx.slice(txPage.skip, txPage.skip + txPage.take);

  // Notification/Toasts
  const [toasts, setToasts] = React.useState([
    { id: 't1', type: 'success', text: 'Welcome back!' }
  ]);
  ...
  return (
    <div
      className={`min-h-screen bg-gray-50 text-gray-900 dark:bg-gray-900 dark:text-gray-100`}
    >
      {/* Header */}
      <AppBar className="sticky top-0 z-40 bg-white/80 dark:bg-gray-800/80 backdrop-blur border-b border-gray-200 dark:border-gray-700 shadow-sm">
          ...
          <div className="flex items-center gap-3">
            <KendoAvatar type="image" rounded="medium">
              <img
                ...
                src="https://dummyimage.com/64x64/111827/ffffff&text=A"
                alt="Acme"
              />
            </KendoAvatar>
        ...
        <AppBarSection className="flex items-center gap-2 ml-auto">
          <div className="relative">
            ...
            {unread > 0 && (
              <span className="absolute -top-0.5 -right-0.5 bg-red-600 text-white text-xs px-1.5 py-0.5 rounded-full shadow">
                {unread}
              </span>
            )}
            {notifOpen && (
                  ...
                  item={(props) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {!it.read && (
                          <span className="inline-block mt-1 h-2 w-2 rounded-full bg-blue-600" />
                        )}
                      </div>
                    );
                  }}
          ...
          <Switch
            className="mx-2"
            checked={themeDark}
            onChange={(e) => setThemeDark(e.value)}
        ...
        <aside className="hidden md:flex md:flex-col w-64 shrink-0 bg-white dark:bg-gray-850 border-r border-gray-200 dark:border-gray-700 transition-all duration-200">
          ...
          <nav className="flex-1 overflow-y-auto px-2">
            <StackLayout orientation="vertical" gap={8}>
              <a
                className="px-2 py-2 rounded-md bg-gray-100 dark:bg-gray-700 font-medium"
                href="#"
              >
                Dashboard
              </a>
              <a
                className="px-2 py-2 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700"
                href="#"
              >
                Analytics
              </a>
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div className="flex items-center gap-3">
                ...
                <Breadcrumb
                  data={[
                    { id: 'home', text: 'Home' },
                    { id: 'dash', text: 'Dashboard' }
                  ]}
                />
              </div>
              <div className="flex items-center gap-2">
                <Button
                  className="bg-gray-900 hover:bg-black text-white px-3 py-2 rounded-md dark:bg-gray-100 dark:text-gray-900 dark:hover:bg-white"
                  onClick={() =>
                    setToasts((prev) => [
                      {
                        id: Date.now() + '',
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-5 border border-gray-100 dark:border-gray-700">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <Button
                      className="px-3 py-1.5 rounded-md bg-gray-900 text-white dark:bg-gray-100 dark:text-gray-900"
                      onClick={() =>
                        setToasts((prev) => [
                          {
                            id: Date.now() + '',
                            type: 'success',
                            text: 'Chart image downloaded'
                          },
                          ...prev
                        ])
                      }
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-5 border border-gray-100 dark:border-gray-700">
                ...
                <Chart style={{ height: 288 }}>
                  ...
                  <ChartSeries>
                    <ChartSeriesItem
                      type={userChartType}
                      data={revenueSeries[0].data.map((v) => v * 120)}
                      name="Users"
                    />
                  </ChartSeries>
                </Chart>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-100 dark:border-gray-700">
              ...
              >
                <GridToolbar>
                  <div className="px-4 py-2 border-b border-gray-100 dark:border-gray-700 flex items-center gap-2 w-full">
                    <Button className="px-3 py-1.5 rounded-md bg-red-600 text-white">
                      Refund
                    </Button>
                    <Button className="px-3 py-1.5 rounded-md bg-gray-900 text-white dark:bg-gray-100 dark:text-gray-900">
                      Export
                    </Button>
                ...
                <Column
                  ...
                  cell={(p) => (
                    <td className="text-right">
                      {formatCurrency(p.dataItem.amount)}
                    </td>
                  )}
                />
                <Column
                    ...
                    <td>
                      <span
                        className={`px-2 py-1 rounded-full text-xs ${
                          p.dataItem.status === 'Paid'
                            ? 'bg-green-100 text-green-700'
                            : p.dataItem.status === 'Pending'
              ...
              <div className="px-4 py-3 border-t border-gray-100 dark:border-gray-700 flex items-center justify-between">
                <Pager
                  ...
                  onPageChange={(e) =>
                    setTxPage({ skip: e.skip, take: e.take })
                  }
                  previousNext
                  type="numeric"
                  pageSizes={[10, 20, 50]}
            ...
            <div className="absolute bottom-16 right-0 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl overflow-hidden">
              <StackLayout orientation="vertical" gap={0}>
                {[
                  ...
                  <button
                    key={text}
                    className="px-4 py-2 hover:bg-gray-50 dark:hover:bg-gray-700 text-left"
                    onClick={() =>
                      setDialog({ open: true, title: text, action: text })
                    }
                  >
                    {text}
                  </button>
      ...
      <footer className="bg-white/80 dark:bg-gray-800/80 backdrop-blur border-t border-gray-200 dark:border-gray-700 px-4 sm:px-6 lg:px-10 py-4">
        <div className="flex items-center justify-between flex-wrap gap-3">
          ...
          <a
            href="#status"
            className="px-2 py-1 rounded-full bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300"
          >
      ...
      {dialog.open && (
        <Dialog
          title={dialog.title}
          onClose={() => setDialog({ open: false, title: '', action: '' })}
          className="z-50"
        >
          <p className="mb-4 text-sm text-gray-700 dark:text-gray-200">
            This is a placeholder form for “{dialog.action}”.
          </p>
          <FieldWrapper>
          ...
          <DialogActionsBar>
            <Button
              onClick={() => setDialog({ open: false, title: '', action: '' })}
            >
              Cancel
            </Button>
            <Button
              themeColor="primary"
              onClick={() => {
                setDialog({ open: false, title: '', action: '' });
                setToasts((prev) => [
                  {
                    id: Date.now() + '',
                    type: 'success',
                    text: `${dialog.action} saved`
                  },
                  ...prev
                ]);
              }}
