...
// TODO: When distributing this MCP server, refactor and integrate coreAgent alongside this MCP server file structure
// instead of importing from the parent project's lib/agents directory
...
server.registerTool(
  ...
  async ({ query }) => {
    ...
    const result = await coreAgent.processUserQuery(query);
